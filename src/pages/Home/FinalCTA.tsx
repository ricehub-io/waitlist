...
export default function FinalCTASection() {
    return (
        <Section className="sm:py-40">
            <div className="bg-pitch border-obsidian relative flex flex-col items-center gap-6 border px-5 py-10 sm:gap-10 sm:px-25 sm:py-20">
                {/* small screen lines */}
                <img
                    src={topLeftLinesSm}
                    alt=""
                ...
                <div className="z-20 flex flex-col items-center text-center sm:max-w-4/7">
